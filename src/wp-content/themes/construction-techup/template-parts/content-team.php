...
?>
	<!-- ======= Team Section ======= -->
    <section class="team-sec constech-team">
      <div class="container">
        <div class="section-heading">
			<?php if($techup_team_title) : ?>	
				<span class="section-title"><?php echo esc_html($techup_team_title); ?></span>
			<?php endif; ?>
			<?php if($techup_team_subtitle) : ?>	
				<h3 class="main-heading"><?php echo esc_html($techup_team_subtitle); ?></h3>
			<?php endif; ?>	
        </div>
        <div class="row">
		    <?php
